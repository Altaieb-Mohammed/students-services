    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">inquries</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="inquries.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
               <i class='fa fa-bullhorn text-dark text-lg'></i>
            </div>
            <span class="nav-link-text ms-1">inquries</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="services.php">
            ...
            <span class="nav-link-text ms-1">departments<li class="nav-item">
          <a class="nav-link  " href="services.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
               <i class='fa fa-cogs text-dark text-lg'></i>
            </div>
            <span class="nav-link-text ms-1">dgrees</span>
          </a>
        </li></span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="services.php">
            ...
            <span class="nav-link-text ms-1">servicess</span>
          </a>
        </li>
